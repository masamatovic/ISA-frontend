...
<!-- Login Form -->
        ...
        <div class="form-row">
            <div  class="form-group col-md-6">
                ...
                <input v-bind:disabled="!izmena" v-model="pacijent.ime"  type="text" id="ime" class="fadeIn second" name="login" >
            </div>
            <div class="form-group col-md-6">
                <label for="exampleInputPassword1">Prezime:</label>
                <input v-bind:disabled="!izmena"  v-model="pacijent.prezime"  type="text" id="prezime" class="fadeIn third" name="login" >
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input  disabled v-model="pacijent.email"  type="text" id="email" class="fadeIn second" name="login" >
            </div>
        </div>
         <div class="form-row">
            <div class="form-group col-md-6">
                <label for="exampleInputPassword1">Adresa:</label>
                <input  v-bind:disabled="!izmena" v-model="pacijent.adresa"  type="text" id="adresa" class="fadeIn second" name="login">
            </div>
            <div class="form-group col-md-6">
                <label for="exampleInputPassword1">Grad:</label>
                <input  v-bind:disabled="!izmena" v-model="pacijent.grad"  type="text" id="grad" name="login" >
            </div>
        </div>
         <div class="form-row">
            <div class="form-group col-md-6">
                <label for="exampleInputPassword1">Drzava:</label>
                <input  v-bind:disabled="!izmena" v-model="pacijent.drzava"  type="text" id="drzava"  name="login" >
            </div>
            <div class="form-group col-md-6">
            ...
            <button v-else @click="sacuvaj" class="btn"><i class="fa fa-save"></i> Sačuvaj izmene</button> 
            <b-button v-if="!izmena" v-b-modal.modal-1><i class="fa fa-lock"></i> Izmeni lozinku</b-button> 
        <div>
